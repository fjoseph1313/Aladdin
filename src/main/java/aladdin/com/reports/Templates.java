...
public class Templates {
	...
	public static final String TEMP_STORAGE = System
	...
	static {
		...
		HyperLinkBuilder link = hyperLink("http://www.aladdin.com");
		...
		cmp.horizontalList(
				...
				cmp.text("Aladdin").setStyle(bold22CenteredStyle)
						.setHorizontalAlignment(HorizontalAlignment.LEFT),

				cmp.text("http://www.aladdin.com").setStyle(italicStyle)
