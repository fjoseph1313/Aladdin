			...
			<div class="col-md-9">
				...
				<div class="row carousel-holder">
					...
					<div class="col-md-12">
							...
							<legend class="registrationLegend">Shipping Information</legend>
								...
								<div class="form-group">
									<label for="countryList" class="col-sm-2 control-label"
										...
										id="countryList" style="width: 200px" name="country"
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control validate[required] text-input"
											id="inputStreet" style="width: 200px" name="street"
						...
						<fieldset>
							<legend class="registrationLegend">Card Information</legend>
								<div class="col-lg-10">
									<div class="form-group">
								...
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										<button type="submit" class="btn btn-primary signIn">Make Payment</button>
									</div>
								</div>
							</form:form>
						</fieldset>
